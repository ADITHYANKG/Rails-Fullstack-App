...
class Admin::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_order" do
    assert_difference("Admin::Order.count") do
      post admin_orders_url, params: { admin_order: { address: @admin_order.address, email: @admin_order.email, fulfilled: @admin_order.fulfilled, total: @admin_order.total } }
    end
  ...
  test "should update admin_order" do
    patch admin_order_url(@admin_order), params: { admin_order: { address: @admin_order.address, email: @admin_order.email, fulfilled: @admin_order.fulfilled, total: @admin_order.total } }
